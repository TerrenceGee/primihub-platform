...
public class PirController {
    ...
    public BaseResultEntity submitPirPhase2(DataPirCopyReq req) {
        ...
        return pirService.submitPirPhase2(req.getDataPirTaskId());
    }
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "taskId", value = "任务ID", dataType = "String", paramType = "query"), @ApiImplicitParam(name = "taskDate", value = "任务创建日期", dataType = "String", paramType = "query")})
