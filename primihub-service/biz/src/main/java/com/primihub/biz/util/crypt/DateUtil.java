...
public class DateUtil {
    ...
    public static Date getStartDateForLastWeek() {
        ...
        return java.sql.Date.valueOf(startOfLastWeek);
    }

    public static Date getEndDateForLastWeek() {
        LocalDate today = LocalDate.now();
        LocalDate endOfLastWeek = today.minusWeeks(1).with(TemporalAdjusters.next(DayOfWeek.SUNDAY));
        return java.sql.Date.valueOf(endOfLastWeek);
    }
}
